...
import java.util.Iterator; //Se agrega para poder usar for each
...
public class ListaLigada<E> extends ListaAbstracta<E> implements Lista<E>, 
    ...
    //Se agrega para poder usar for-each
    @Override
    public Iterator<E> iterator(){
        return new IteradorListaLigada().iterator();
    }
     ...
     * @author Flores González Luis Brandon
     */
    private class IteradorListaLigada implements Iterable<E>, Iterator<E>, 
            IteradorLista<E>{
